            ...
            <form action="{{route('contact.store')}}" method="POST">
              ...
              <div class="row form-group">
                <div class="col-md-6 mb-3 mb-md-0">
                  ...
                  <input type="text" id="fname" name="frist" class="form-control @error('frist') is-invalid @enderror" required autocomplete="frist" autofocus>
                </div>
                <div class="col-md-6">
                  <label class="text-black" for="lname">Last Name</label>
                  <input type="text" id="lname" name="last" class="form-control @error('last') is-invalid @enderror" required autocomplete="last" autofocus >
                </div>
              </div>
